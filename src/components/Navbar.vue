...
<template>
  <div :class="curr=='/countdown' && 'hidden'" class="bg-white h-12 flex justify-around items-center px-[5%] md:px-[10%] lg:px-36 py-0.5 shadow-lg fixed w-full z-50 text-teal-t">
