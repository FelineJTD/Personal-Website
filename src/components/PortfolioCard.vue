...
<template>
  <div class="min-w-64 rounded-xl bg-coral-500 bg-[url('./assets/texture-25.png')] bg-blend-overlay relative w-full text-center p-4 md:p-6 shadow-xl text-white" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave">
